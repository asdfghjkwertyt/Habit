...
class HabitWidgetProvider : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (intent.action) {
            ACTION_MARK_COMPLETED -> {
                ...
                if (habitId > 0L) {
                    Log.d("HabitWidgetProvider", "ACTION_MARK_COMPLETED habitId=$habitId")
            ...
            ACTION_NEXT_HABIT -> {
                ...
                if (widgetId != AppWidgetManager.INVALID_APPWIDGET_ID) {
                    Log.d("HabitWidgetProvider", "ACTION_NEXT_HABIT widgetId=$widgetId")
                    val pendingResult = goAsync()
                    CoroutineScope(Dispatchers.IO).launch {
                        runCatching {
    ...
    companion object {
        ...
        private const val PREF_INDEX_PREFIX = "habit_index_"
